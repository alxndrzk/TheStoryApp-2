...
import com.dicoding.thestoryapp.util.*
...
class AuthViewModelTest {
    ...
    companion object{
        private const val LOGIN_CORRECT_EMAIL = "alexander@gmail.com"
        private const val LOGIN_CORRECT_PASSWORD = "secured"
        private const val LOGIN_WRONG_PASSWORD = "not secured"

        private const val REGISTER_NAME = "alexander"
        private const val REGISTER_EMAIL = "alexander@gmail.com"
        private const val REGISTER_EXISTING_EMAIL = "ramamau@gmail.com"
    ...
    fun `When post login it returns Result Success and success response data`() {
        ...
        val expectedValues = MutableLiveData<Result<ResponseLogin>>()
