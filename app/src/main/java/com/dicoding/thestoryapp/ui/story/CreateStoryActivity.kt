...
class CreateStoryActivity : AppCompatActivity() {
    ...
    private var createImgFile: File? = null
    ...
    private val launcherIntentCameraX = registerForActivityResult(
        ...
        if (activityResult.resultCode == CAMERA_X_RESULT) {
            ...
            createImgFile = reduceFileImage(myFile)
    ...
    private val launcherImageGallery = registerForActivityResult(
        ...
        if (activityResult.resultCode == RESULT_OK) {
            ...
            createImgFile = reduceFileImage(createFile)
    ...
    private fun validation() {
        ...
        isLoading(true)
        createStoryViewModel.createStory(description, createImgFile as File).observe(this) { responseGeneralResult ->
    ...
    private fun isLoading(isL: Boolean) {
        viewbinding.btnAdd.isEnabled = !isL
        if (isL) {
